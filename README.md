...
# Studying 1000GP and HGDP
In this part, we share the code for analyzing IBD segments widely in two public genomic database, 1000GP and HGDP. We will test different algorithms and evaluate output for fine-grain population structure.
